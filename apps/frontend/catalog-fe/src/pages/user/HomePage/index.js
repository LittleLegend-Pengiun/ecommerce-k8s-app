...
const HomePage = () => {
  ...
  const displayProducts = featProducts.all.products.slice(pagesVisited, pagesVisited + productsPerPage).map((item, index) => {
    return (
  ...
  const pageCount = Math.ceil(featProducts.all.products.length / productsPerPage);
